...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transition-colors",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground border border-primary-border hover:opacity-90",
        destructive: "bg-destructive text-destructive-foreground border border-destructive-border hover:opacity-90",
        outline: "border [border-color:var(--button-outline)] hover:bg-accent hover:text-accent-foreground",
        secondary: "border bg-secondary text-secondary-foreground border-secondary-border hover:opacity-90",
        ghost: "border border-transparent hover:bg-accent hover:text-accent-foreground",
        whiteOutline: "border border-white text-white bg-transparent hover:bg-white hover:text-primary"
      },
      size: {
